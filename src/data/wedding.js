const wedding = {
  partnerA: "Celeste",
  partnerB: "Rowan",
  partnerAFull: "Celeste Dubois",
  partnerBFull: "Rowan Pierce",
  monogram: "C & R",
  hashtag: "#DuboisPierce",

  // Saturday, September 27, 2027, 5:00 PM
  date: "2027-09-27T17:00:00",
  dateDisplay: "Saturday, the Twenty-Seventh of September",
  yearDisplay: "Two Thousand Twenty-Seven",

  venueName: "Fern Hollow Estate",
  venueCity: "Carmel Valley, California",

  story:
    "They met at a trailhead in the Berkshires — she was reading a map upside down, " +
    "he was too kind to say so for the first mile. Six years of adventures, three " +
    "national parks, and one very opinionated rescue dog later, the next chapter writes itself.",
