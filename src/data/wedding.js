const wedding = {
  ...
  guestList: [
    ...
    { name: "Caroline Wu", table: 6 },
    { name: "David Park", table: 1 },
    { name: "Elena Vasquez", table: 3 },
    { name: "Frank Morrison", table: 5 },
    { name: "Grace Kim", table: 7 },
    { name: "Hassan Ali", table: 8 },
    { name: "Isabella Torres", table: 4 },
    { name: "James O'Brien", table: 2 },
    { name: "Katherine Lee", table: 1 },
    { name: "Liam Patel", table: 6 },
    { name: "Mia Rodriguez", table: 3 },
    { name: "Nathan Brooks", table: 5 },
    { name: "Olivia Chang", table: 7 },
    { name: "Patrick Sullivan", table: 8 },
    { name: "Quinn Reyes", table: 4 },
    { name: "Rachel Thompson", table: 2 },
    { name: "Samuel Davis", table: 1 },
    { name: "Tara Nguyen", table: 6 },
    { name: "Uma Kapoor", table: 3 },
    { name: "Victor Osei", table: 5 },
    { name: "Wendy Chen", table: 7 },
    { name: "Xavier Martin", table: 8 },
    { name: "Yasmine Abdel", table: 4 },
    { name: "Zoe Anderson", table: 2 },
    { name: "Alex Rivera", table: 1 },
